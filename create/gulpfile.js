...
gulp.task('js',function(){
	gulp.src(['indexpage.js','controller/*Controller.js'])
		.pipe(concat('app.min.js'))
		.pipe(uglify())
		.pipe(gulp.dest(''))
});
gulp.task('mywatch',function(){
	gulp.watch('view/*.less',['less']);//当第一个参数发生变化时，执行第二个参数
	gulp.watch('controller/*Controller.js',['js']);
	gulp.watch('indexpage.js',['js']);
});
